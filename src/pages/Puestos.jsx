...
<Puesto
  ...
  empresa="Evoxlab"
  descripcion="Diseñé y desarrollé plataformas web.
              • Construí el backend con PHP sobre CodeIgniter4, definiendo rutas, controladores y modelos para gestionar usuarios, clases, pagos e
                inscripciones.
              • Implementé el frontend con HTML, TailwindCSS y JavaScript, creando interfaces responsivas e interactivas.
              • Integré pasarelas de pago como Stripe, configurando webhooks y asegurando transacciones seguras y fluidas.
              • Desarrollé sistemas de autenticación y validación de datos, y optimicé consultas a la base de datos para garantizar rendimiento y seguridad.
...
<Puesto
  ...
  descripcion="Diseño y desarrollo de la interfaz visual de una tienda online. 
...
/>
  ...
  descripcion="Desarrollo de una plataforma para gestionar inscripciones, clases y pagos de alumnos. 
               • Creación de interfaces limpias y fáciles de usar, optimizando la experiencia del usuario.
...
<Puesto
  ...
  descripcion="Desarrollé un sistema de gestión de almacenamiento de materiales para una institución educativa. 
...
<Puesto
  ...
  empresa="Inova"
  descripcion="Desarrollé una interfaz en JavaScript para gestionar preguntas de mantenimiento para distintas máquinas. 
               • Implementé funcionalidades dinámicas para agregar y eliminar preguntas.
